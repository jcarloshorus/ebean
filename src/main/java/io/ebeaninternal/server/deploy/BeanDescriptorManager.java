...
public class BeanDescriptorManager implements BeanDescriptorMap {
    ...
    /**
     * Map of base tables to 'with history views' used to support 'as of'
     * queries.
     */
    ...
    /**
     * Return the versions between timestamp suffix based on the
     * DbHistorySupport.
     */
    ...
    /**
     * Deploy returning the asOfTableMap (which is required by the SQL
     * builders).
     */
    ...
    /**
     * Return true if there are 'view based entities' using l2 query caching and
     * so need to be invalidated based on changes to dependent tables.
     */
    ...
    /**
     * Create and add a Unidirectional property (for ElementCollection) which
     * maps to the foreign key.
     */
    ...
    /**
     * Return true if this is a MappedSuperclass bean with no persistent
     * properties. If so it is ok for it not to be enhanced.
     */
